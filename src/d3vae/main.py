...
parser.add_argument('--checkpoints', type=str, default='./checkpoints', help='name of the checkpoint directory')
...
parser.add_argument('--generate', type=bool, default=False,help='whether to generate synthetic data')
parser.add_argument('--sample_size', type=int, default=1000,help='# of samples to generate')
...
if args.generate:
    ...
    setting = 'D3VAE_{}_sl_{}_pl{}_{}_dim{}_scale{}_diffsteps{}_itr{}'.format(args.data, args.sequence_length,
             args.prediction_length, 0, args.dim,  args.scale, args.diff_steps, 0)
    exp = Exp(args)
    exp.generate(setting)
else:  
    all_mse = []
    all_mae = []
