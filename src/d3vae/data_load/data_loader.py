...
class Dataset_Custom(Dataset):
    ...
    def __init__(self, root_path, flag='train', size=None, features='S', data_path='ETTh1.csv', target='OT', scale=True,
                 inverse=False, timeenc=1, freq='t', cols=None, percentage=0.03, data_split = [0.7, 0.1, 0.2]):
        ...
        # init
        assert flag in ['train', 'test', 'val', 'generate']
        type_map = {'train':0, 'val':1, 'test':2, 'generate': 0}
    ...
    def __read_data__(self):
        ...
        num_train = int(length*self.data_split[0])
        num_vali = int(length*self.data_split[1])
        num_test = int(length*self.data_split[2])
