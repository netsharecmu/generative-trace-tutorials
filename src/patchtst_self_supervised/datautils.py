...
DSETS = ['ettm1', 'ettm2', 'etth1', 'etth2', 'electricity',
         'traffic', 'illness', 'weather', 'exchange', 'pcap', 'netflow'
        ]
...
def get_dls(params):
    ...
    print("dls vars, lens, c", dls.vars, dls.len, dls.c)
    return dls
