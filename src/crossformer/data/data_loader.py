...
class Dataset_MTS(Dataset):
    def __init__(self, root_path, data_path='ETTh1.csv', flag='train', size=None, 
                  data_split = [0.8, 0.2, 0], scale=True, scale_statistic=None):
    ...
    def __read_data__(self):
        ...
        border1s = [0, train_num - self.in_len, train_num + val_num - self.in_len, 0]
        border2s = [train_num, train_num+val_num, train_num + val_num + test_num, train_num + val_num + test_num]
