...
mae, mse, rmse, mape, mspe = exp.generate(args.setting_name, args.save_pred, args.inverse)

folder_path = os.path.join(args.work_folder, 'results', args.setting_name)
if not os.path.exists(folder_path):
    os.makedirs(folder_path)
log_file = open(os.path.join(folder_path, 'metric.log'), 'w')
