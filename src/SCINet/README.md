...
# SCINet with pcap/netflow generation 

# 1. Training 
* Configurations 
    * seq_len = look back window (input lenght)
    * pred_len = prediction window (output length)
    * checkpoints = dir that stores the checkpoint files  
    * If you want to change the dataset name you should modify `run_ETTh.py` 
    * `label_len` doesn't matter at all because they don't use this param during the training (this is a old param from Informer codebase);
    * `skip_testing` and `data_split` is same as others

### PCAP 
```
python run_ETTh.py --root_path  ../../dataset/  --data PCAP --features M  --seq_len 48 --label_len 24 --pred_len 24 --hidden-size 4 --stacks 1 --levels 3 --lr 3e-3 --batch_size 8 --dropout 0.5 --model_name pcap_M_I48_O24_lr3e-3_bs8_dp0.5_h4_s1l3 --inverse True --skip_testing True --data_split '0.7,0.3,0.0'
```

### Netflow  
```
python run_ETTh.py --root_path  ../../dataset/  --data NETFLOW --features M  --seq_len 48 --label_len 24 --pred_len 24 --hidden-size 4 --stacks 1 --levels 3 --lr 3e-3 --batch_size 8 --dropout 0.5 --model_name netflow_M_I48_O24_lr3e-3_bs8_dp0.5_h4_s1l3 --save True --inverse True --skip_testing True --data_split '0.7,0.3,0.0'
```

# 2. Generation 

* the result of prediction will be: e.g., `forecasting-models/SCINet/exp/ett_results/SCINet_NETFLOW_ftM_sl48_ll24_pl24_lr0.003_bs8_hid4.0_s1_l3_dp0.5_invTrue_itr0`
* the model will be e.g., `forecasting-models/SCINet/exp/ETT_checkpoints/SCINet_NETFLOW_ftM_sl48_ll24_pl24_lr0.003_bs8_hid4.0_s1_l3_dp0.5_invTrue_itr0`
* IMPORTANT: we should read pred_scales.npy for post-processor! 
* sample_size is the number of generated items

### PCAP 
python run_ETTh.py --root_path  ../../dataset/  --data PCAP --features M  --seq_len 48 --label_len 24 --pred_len 24 --hidden-size 4 --stacks 1 --levels 3 --lr 3e-3 --dropout 0.5 --model_name pcap_M_I48_O24_lr0.003_bs8_dp0.5_h4_s1l3 --generate True --inverse True --batch_size 8 --save True --sample_size 1000 --data_split '0.7,0.3,0.0'

### Netflow  
```
python run_ETTh.py --root_path  ../../dataset/  --data NETFLOW --features M  --seq_len 48 --label_len 24 --pred_len 24 --hidden-size 4 --stacks 1 --levels 3 --lr 3e-3 --dropout 0.5 --model_name netflow_M_I48_O24_lr0.003_bs8_dp0.5_h4_s1l3 --generate True --inverse True --batch_size 8 --save True --sample_size 1000 --data_split '0.7,0.3,0.0'
```

# 3. post-process from root folder with this configuration
```
IS_TARGET_APPENDED = True
```
