...
### -------  dataset settings --------------
parser.add_argument('--data', type=str, required=False, default='ETTh1', choices=['ETTh1', 'ETTh2', 'ETTm1', 'PCAP', 'NETFLOW'], help='name of dataset')
...
data_parser = {
    ...
    'PCAP': {'data': 'ohe-pcap.csv', 'T': 'pkt_len', 'M': [13, 13, 13], 'S': [1, 1, 1], 'MS': [13, 13, 1]},
    'NETFLOW': {'data': 'raw_bits_transformed_forecasting.csv', 'T': 'td', 'M': [199, 199, 199], 'S': [1, 1, 1], 'MS': [199, 199, 1]},
}
