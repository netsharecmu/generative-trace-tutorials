...
### -------  dataset settings --------------
parser.add_argument('--data', type=str, required=False, default='ETTh1', choices=['ETTh1', 'ETTh2', 'ETTm1', 'ugr16', 'cidds', 'ton', 'caida', 'dc', 'ca', 'm57'], help='name of dataset')
...
parser.add_argument('--work_folder', type=str, default='ETTh1', help='experiment directory')
...
parser.add_argument('--skip_testing', type=bool, default=False, help='Whether to skip testing')
...
data_parser = {
    ...
    'ugr16': {'data': 'dummy-netflow.csv', 'T': 'byt', 'M': [202, 202, 202], 'S': [1, 1, 1], 'MS': [202, 202, 1]},
    'cidds': {'data': 'dummy-netflow.csv', 'T': 'byt', 'M': [184, 184, 184], 'S': [1, 1, 1], 'MS': [184, 184, 1]},
    'ton': {'data': 'dummy-netflow.csv', 'T': 'byt', 'M': [204, 204, 204], 'S': [1, 1, 1], 'MS': [204, 204, 1]},
    'caida': {'data': 'dummy-pcap.csv', 'T': 'pkt_len', 'M': [203, 203, 203], 'S': [1, 1, 1], 'MS': [203, 203, 1]},
    'dc': {'data': 'dummy-pcap.csv', 'T': 'pkt_len', 'M': [202, 202, 202], 'S': [1, 1, 1], 'MS': [202, 202, 1]},
    'ca': {'data': 'dummy-pcap.csv', 'T': 'pkt_len', 'M': [185, 185, 185], 'S': [1, 1, 1], 'MS': [185, 185, 1]},
    'm57': {'data': 'dummy-pcap.csv', 'T': 'pkt_len', 'M': [202, 202, 202], 'S': [1, 1, 1], 'MS': [202, 202, 1]}
}
...
# Yucheng: We need some randomness to measure the variance of the results
...
if args.generate:
    ...
    mae, maes, mse, mses = exp.generate(setting, generate=True)
