...
if __name__ == "__main__":
  ...
  print(f"generate artificial data successfully")

  # load model and generate ugr16-format netflow data
  test_ugr16('stan_data/ugr16_demo.csv', True) 

  print(f"load model and generate ugr16-format netflow data successfully")
  ...
  print(f"train and generate ugr16-format netflow data successfully")
